...
- Removed the dependent from `xorm.io/core` and moved the codes to `github.com/tdwiid/xorm/core`, `github.com/tdwiid/xorm/names`, `github.com/tdwiid/xorm/schemas` and others.
